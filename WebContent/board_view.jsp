			...
			<div id="joinForm">
				...
				<fieldset>
					...
					<c:choose>
						<c:when test="${!empty boardDTO.attached_file}">
							<p>
								...
								&nbsp;&nbsp;&nbsp; <a
									href="./BoardDownload.do?attached_file=<c:out value="${boardDTO.attached_file}" />">
									파일 다운로드 </a> <br />
							</p>
						</c:when>
						<c:otherwise>
					...
					<div class="btnJoinArea">
						...
						</a> <a href="./BoardModify.do?num=<c:out value="${boardDTO.num}"/>">
							<button type="button" class="btnOk">수정</button>
						</a> <a href="./BoardDelete.do?num=<c:out value="${boardDTO.num}"/>">
							<button type="button" class="btnOk">삭제</button>
						</a>
						<button type="button" value="button"
							onclick="location.href='./BoardList.do'" class="btnOk">
							목록</button>
					</div>
				</fieldset>
			</div>
